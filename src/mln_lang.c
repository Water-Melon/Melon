...
int mln_lang_func_detail_arg_append(mln_lang_func_detail_t *func, mln_lang_var_t *var)
{
    mln_lang_var_t **v;
...
inline int mln_lang_funccall_val_add_arg(mln_lang_funccall_val_t *func, mln_lang_var_t *var)
{
    mln_lang_var_t **v;
