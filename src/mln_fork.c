...
static inline void
mln_socketpair_close_handler(mln_event_t *ev, mln_fork_t *f, int fd);
...
mln_socketpair_close_handler(mln_event_t *ev, mln_fork_t *f, int fd)
{
    mln_event_set_fd(ev, fd, M_EV_CLR, NULL, NULL);
