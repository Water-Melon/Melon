...
static int mln_lang_file_addOpen(mln_lang_ctx_t *ctx, mln_lang_set_detail_t *set)
{
    ...
    if ((func = mln_lang_func_detail_new(ctx, M_FUNC_INTERNAL, mln_lang_open_process, NULL)) == NULL) {
        mln_lang_errmsg(ctx, "No memory.");
        return -1;
    }
...
static int mln_lang_file_addLseek(mln_lang_ctx_t *ctx, mln_lang_set_detail_t *set)
{
    ...
    if ((func = mln_lang_func_detail_new(ctx, M_FUNC_INTERNAL, mln_lang_lseek_process, NULL)) == NULL) {
        mln_lang_errmsg(ctx, "No memory.");
        return -1;
    }
    if ((val = mln_lang_val_new(ctx, M_LANG_VAL_TYPE_NIL, NULL)) == NULL) {
...
static int mln_lang_file_addRead(mln_lang_ctx_t *ctx, mln_lang_set_detail_t *set)
{
    ...
    if ((func = mln_lang_func_detail_new(ctx, M_FUNC_INTERNAL, mln_lang_read_process, NULL)) == NULL) {
        mln_lang_errmsg(ctx, "No memory.");
        return -1;
    }
    if ((val = mln_lang_val_new(ctx, M_LANG_VAL_TYPE_NIL, NULL)) == NULL) {
...
static int mln_lang_file_addWrite(mln_lang_ctx_t *ctx, mln_lang_set_detail_t *set)
{
    ...
    if ((func = mln_lang_func_detail_new(ctx, M_FUNC_INTERNAL, mln_lang_write_process, NULL)) == NULL) {
        mln_lang_errmsg(ctx, "No memory.");
        return -1;
    }
    if ((val = mln_lang_val_new(ctx, M_LANG_VAL_TYPE_NIL, NULL)) == NULL) {
...
static int mln_lang_file_addClose(mln_lang_ctx_t *ctx, mln_lang_set_detail_t *set)
{
    ...
    if ((func = mln_lang_func_detail_new(ctx, M_FUNC_INTERNAL, mln_lang_close_process, NULL)) == NULL) {
        mln_lang_errmsg(ctx, "No memory.");
        return -1;
    }
    if ((val = mln_lang_val_new(ctx, M_LANG_VAL_TYPE_FUNC, func)) == NULL) {
...
static int mln_lang_file_addErrmsg(mln_lang_ctx_t *ctx, mln_lang_set_detail_t *set)
{
    ...
    if ((func = mln_lang_func_detail_new(ctx, M_FUNC_INTERNAL, mln_lang_errmsg_process, NULL)) == NULL) {
        mln_lang_errmsg(ctx, "No memory.");
        return -1;
    }
    if ((val = mln_lang_val_new(ctx, M_LANG_VAL_TYPE_FUNC, func)) == NULL) {
...
static int mln_lang_file_addSize(mln_lang_ctx_t *ctx, mln_lang_set_detail_t *set)
{
    ...
    if ((func = mln_lang_func_detail_new(ctx, M_FUNC_INTERNAL, mln_lang_size_process, NULL)) == NULL) {
        mln_lang_errmsg(ctx, "No memory.");
        return -1;
    }
    if ((val = mln_lang_val_new(ctx, M_LANG_VAL_TYPE_FUNC, func)) == NULL) {
