...
/*for internal*/
#define mln_http_get_Done(h)             ((h)->done)
#define mln_http_set_Done(h,hd)          (h)->done = (hd)

/*for external*/
#define mln_http_get_connection(h)       ((h)->connection)
#define mln_http_set_connection(h,c)     (h)->connection = (c)
#define mln_http_get_pool(h)             ((h)->pool)
#define mln_http_set_pool(h,p)           (h)->pool = (p)
#define mln_http_get_data(h)             ((h)->data)
#define mln_http_set_data(h,d)           (h)->data = (d)
#define mln_http_get_uri(h)              ((h)->uri)
#define mln_http_set_uri(h,u)            (h)->uri = (u)
#define mln_http_get_args(h)             ((h)->args)
#define mln_http_set_args(h,a)           (h)->args = (a)
#define mln_http_get_status(h)           ((h)->status)
#define mln_http_set_status(h,s)         (h)->status = (s)
#define mln_http_get_method(h)           ((h)->method)
#define mln_http_set_method(h,m)         (h)->method = (m)
#define mln_http_get_version(h)          ((h)->version)
#define mln_http_set_version(h,v)        (h)->version = (v)
#define mln_http_get_type(h)             ((h)->type)
#define mln_http_set_type(h,t)           (h)->type = (t)
#define mln_http_get_handler(h)          ((h)->body_handler)
#define mln_http_set_handler(h,hlr)      (h)->body_handler = (hlr)
#define mln_http_get_response_msg(h)     ((h)->response_msg)
#define mln_http_set_response_msg(h,m)   (h)->response_msg = (m)
#define mln_http_get_error(h)            ((h)->error)
#define mln_http_set_error(h,e)          (h)->error = (e)
#define mln_http_get_header(h)           ((h)->header_fields)
 ...
 * the error_code via mln_http_get_error().
